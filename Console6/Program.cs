...
namespace ConsoleApp
{
    class Program
    {
        static void Main()
        {
            ...
            /*Console App 6*/
            List<string> cakes2 = new List<string>() { "mango", "mango", "yema","vanilla"};
            List<string> cake = new List<string>();

            foreach (string cakes in cakes2)
            {

                if (cakes2.Contains(cakes))//a loop that iterates through the list and then displays the indices of the list that contain matching text on the screen
                {
